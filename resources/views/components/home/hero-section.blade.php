                        ...
                        <div class="relative rounded-2xl overflow-hidden border border-white/20 flex-1 min-h-0 shadow-xl shadow-black/30">
                            ...
                            <div class="absolute inset-0 flex flex-col justify-between p-5 z-20">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('posts.berita') }}" class="px-4 py-2 bg-yellow-500 border border-yellow-400 rounded-full text-[#0f172a] text-sm font-bold hover:bg-yellow-400 transition-all duration-300">
                                        Baca Berita
                                    </a>
                                </div>
                            </div>
