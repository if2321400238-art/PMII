...
<div class="w-full">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-4 md:mb-6">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Tambah Korwil</h1>
            <p class="text-sm md:text-base text-gray-600 mt-1">Tambahkan koordinator wilayah baru</p>
        </div>
        ...
        <form action="{{ route('admin.korwil.store') }}" method="POST" class="space-y-4 md:space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-4 md:p-6 space-y-4 md:space-y-6">
                    <div>
                        <label for="name" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Nama Korwil <span class="text-red-500">*</span></label>
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                            class="w-full px-3 md:px-4 py-2 md:py-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('name') border-red-500 @enderror"
                    ...
                    <div>
                        <label for="wilayah" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Wilayah <span class="text-red-500">*</span></label>
                        <input type="text" id="wilayah" name="wilayah" value="{{ old('wilayah') }}"
                            class="w-full px-3 md:px-4 py-2 md:py-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('wilayah') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <div>
                            <label for="password" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Password <span class="text-red-500">*</span></label>
                            <input type="password" id="password" name="password"
                                class="w-full px-3 md:px-4 py-2 md:py-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('password') border-red-500 @enderror"
                    ...
                    <div>
                        <label for="description" class="block text-xs md:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Deskripsi</label>
                        <textarea id="description" name="description" rows="4"
                            class="w-full px-3 md:px-4 py-2 md:py-3 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('description') border-red-500 @enderror"
            ...
            <div class="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-4 pt-4">
                <a href="{{ route('admin.korwil.index') }}"
                   class="px-4 md:px-6 py-2 md:py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition font-medium text-sm md:text-base flex items-center justify-center">
                ...
                <button type="submit"
                        class="px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition font-medium text-sm md:text-base shadow-lg shadow-green-500/30 flex items-center justify-center">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
