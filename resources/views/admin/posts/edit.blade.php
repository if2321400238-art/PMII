                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="thumbnail_caption" rows="2"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition @error('thumbnail_caption') border-red-500 @enderror">{{ old('thumbnail_caption', $post->thumbnail_caption) }}</textarea>
