...
@section('title', 'Tambah Kategori - Admin PMII')
...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">Buat kategori baru seperti Opini, Berita, atau lainnya</p>
    </div>
    ...
    <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="slug" name="slug" value="{{ old('slug') }}"
                           ...
                           placeholder="Contoh: opini">
                    <p class="text-xs text-gray-500 mt-2">Kosongkan jika ingin dibuat otomatis dari nama.</p>
        ...
        <div class="flex gap-4">
            ...
            <button type="submit" class="flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white font-semibold rounded-lg hover:from-green-700 hover:to-green-800 transition shadow-lg">Simpan Kategori</button>
        </div>
    </form>
</div>
@endsection
