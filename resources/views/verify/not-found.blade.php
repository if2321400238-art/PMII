...
<div class="min-h-screen bg-gradient-to-br from-red-50 to-red-100 py-12">
    <div class="max-w-lg mx-auto px-4">
        ...
        <div class="text-center mb-6">
            <div class="inline-flex items-center justify-center w-20 h-20 rounded-full bg-red-100 mb-4" aria-hidden="true">
                <svg class="w-12 h-12 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                </svg>
            </div>
            <h1 class="text-2xl font-bold text-red-800">Anggota Tidak Ditemukan</h1>
            <p class="text-gray-700 mt-2">Data anggota dengan nomor ini tidak terdaftar</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-red-600 to-red-700 px-6 py-4 text-center">
                ...
                <p class="text-red-100 text-sm">KTA tidak valid atau sudah tidak berlaku</p>
            </div>

            <!-- Content -->
            <div class="p-6 text-center">
                <div class="bg-gray-100 rounded-lg p-4 mb-4">
                    <p class="text-sm text-gray-700 mb-1">Nomor yang dicari:</p>
                    <p class="text-xl font-bold text-gray-900 font-mono">{{ $nomor_anggota }}</p>
                </div>

                <div class="text-sm text-gray-700">
                    <p class="mb-2 font-medium">Kemungkinan penyebab:</p>
                    <ul class="text-left list-disc list-inside space-y-1 text-gray-600">
