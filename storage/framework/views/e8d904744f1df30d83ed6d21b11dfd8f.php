<?php $__env->startSection('title', 'Beranda - ISKAB | Ikatan Santri Kalimantan Barat'); ?>
<?php $__env->startSection('description', 'Website resmi Ikatan Santri Kalimantan Barat (ISKAB). Organisasi santri se-Kalimantan Barat yang mempererat silaturahmi dan mengembangkan potensi santri.'); ?>
<?php $__env->startSection('keywords', 'ISKAB, Ikatan Santri Kalimantan Barat, Santri Kalbar, Organisasi Santri, Pesantren Kalbar'); ?>
        ...
        <?php if(count($heroImages) > 0): ?>
            ...
            <div class="hero-slider absolute inset-0 z-0">
                <?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $heroImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="hero-slide absolute inset-0 transition-opacity duration-1000 <?php echo e($index === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'); ?>"
                        data-index="<?php echo e($index); ?>">
                        <img src="<?php echo e(asset('storage/' . $heroImage)); ?>" alt="Hero Background <?php echo e($index + 1); ?>"
            ...
            <?php if(count($heroImages) > 1): ?>
                <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex gap-2">
                    <?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $heroImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button
                            class="hero-dot w-3 h-3 rounded-full <?php echo e($index === 0 ? 'bg-white' : 'bg-white/50'); ?> transition-all duration-300"
        ...
        <div class="max-w-7xl mx-auto px-6 sm:px-12 lg:px-40">
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('about.korwil')); ?>">
                            <div class="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 counter"
                                data-target="<?php echo e($stats['korwil']); ?>">0</div>
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('about.rayon')); ?>">
                            <div class="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 counter"
                                data-target="<?php echo e($stats['rayon']); ?>">0</div>
            ...
            <div class="relative sm:col-span-2 md:col-span-1">
                ...
                <div
                    class="relative bg-gradient-to-br from-[#48D853] to-[#26722C] rounded-2xl md:rounded-3xl p-6 md:p-8 text-center shadow-2xl transform hover:scale-105 transition">
                    <div class="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-2 counter"
                        data-target="<?php echo e($stats['anggota']); ?>">0</div>
                        ...
                        <div id="beritaContainer" class="flex gap-4 lg:gap-6 py-2">
                            <?php $__empty_1 = true; $__currentLoopData = $beritaTerkini; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <article
                                    ...
                                    onclick="window.location.href='<?php echo e(route('posts.show', $post->slug)); ?>'">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
                                        ...
                                        <h3 class="text-sm md:text-base font-bold line-clamp-2">
                                            <a href="<?php echo e(route('posts.show', $post->slug)); ?>"
                                                class="hover:text-green-300"><?php echo e($post->title); ?></a>
                                        </h3>
                                        <p class="text-gray-200 text-xs line-clamp-1"><?php echo e(strip_tags($post->content)); ?></p>
                                    </div>
                                </article>
    ...
    <section class="bg-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20">
            ...
            <div class="lg:hidden relative">
                ...
                <div id="penaSantriCarousel" class="overflow-x-auto overflow-y-hidden scroll-smooth scrollbar-hide mx-8">
                    <div class="flex gap-4 py-2">
                        <?php $__empty_1 = true; $__currentLoopData = $penaSantriHighlight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <article
                                ...
                                <div class="absolute bottom-0 left-0 right-0 p-5 text-white">
                                    ...
                                    <p class="text-gray-200 text-sm line-clamp-2"><?php echo e(strip_tags($post->content)); ?></p>
                                </div>
                            </article>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div class="w-full text-center py-8">
            ...
            <div class="hidden lg:grid grid-cols-3 gap-6">
                <?php $__empty_1 = true; $__currentLoopData = $penaSantriHighlight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if($index === 0): ?>
                        <!-- Artikel Utama -->
                        <article
                ...
                <?php if($penaSantriHighlight->count() < 5): ?>
                    <?php for($i = $penaSantriHighlight->count(); $i < 5; $i++): ?>
                        <?php if($i === 0): ?>
