<?php $__env->startSection('title', 'Tambah File Download - Admin PMII'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-5xl mx-auto">
        ...
        <form action="<?php echo e(route('admin.download.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    <div>
                        ...
                        <input type="text" name="nama_file" value="<?php echo e(old('nama_file')); ?>"
                    ...
                    <div>
                        ...
                        <select name="kategori" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition" required>
                            ...
                            <option value="logo" <?php echo e(old('kategori') === 'logo' ? 'selected' : ''); ?>>Logo</option>
                            <option value="ad_art" <?php echo e(old('kategori') === 'ad_art' ? 'selected' : ''); ?>>AD/ART</option>
                            <option value="administrasi" <?php echo e(old('kategori') === 'administrasi' ? 'selected' : ''); ?>>Administrasi</option>
                            <option value="surat_template" <?php echo e(old('kategori') === 'surat_template' ? 'selected' : ''); ?>>Template Surat</option>
                            <option value="panduan_lain" <?php echo e(old('kategori') === 'panduan_lain' ? 'selected' : ''); ?>>Panduan Lain</option>
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                                  ...
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"><?php echo e(old('deskripsi')); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end space-x-4 pt-4">
                <a href="<?php echo e(route('admin.download.index')); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/download/create.blade.php ENDPATH**/ ?>