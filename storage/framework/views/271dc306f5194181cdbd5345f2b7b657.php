<section class="bg-white py-12 md:py-14 section-reveal cinematic-section premium-section" data-reveal data-cinematic>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <?php if($galleryHighlight->isNotEmpty()): ?>
            <?php
            ...
            <div class="gallery-collage" data-reveal>
                <?php $__currentLoopData = $galleryHighlight; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $galleryTitle = \Illuminate\Support\Str::limit(trim($gallery->title ?? ''), 48);
                        $layoutClass = $layoutClasses[$loop->index % count($layoutClasses)];
                    ?>
                    <article class="gallery-tile <?php echo e($layoutClass); ?> card-reveal cursor-pointer" style="--reveal-delay: <?php echo e($loop->index * 60); ?>ms;" data-reveal-card onclick="window.location.href='<?php echo e(route('gallery.show', $gallery->id)); ?>'">
                        <?php if($gallery->type === 'video'): ?>
                            ...
                            <?php elseif($gallery->video_thumbnail_url): ?>
                                <img src="<?php echo e($gallery->video_thumbnail_url); ?>" alt="<?php echo e($galleryTitle); ?>" loading="lazy" decoding="async" fetchpriority="low">
                            <?php else: ?>
                        ...
                        <?php else: ?>
                            <?php if($gallery->file_path): ?>
                                <img src="<?php echo e(route('img.optimized', ['path' => $gallery->file_path, 'w' => 720])); ?>" alt="<?php echo e($galleryTitle); ?>" loading="lazy" decoding="async" fetchpriority="low">
                            <?php else: ?>
        ...
        <div class="mt-8 flex justify-center">
            <a href="<?php echo e(route('gallery.index')); ?>" class="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white px-5 py-2.5 text-sm font-semibold text-blue-700 shadow-sm hover:bg-blue-50 transition">
