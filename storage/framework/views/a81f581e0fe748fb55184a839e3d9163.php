<?php $__env->startSection('title', 'Anggota - Admin ISKAB'); ?>
    ...
    <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
        <div>
            ...
            <select id="filter-korwil" name="korwil" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500 focus:border-green-500">
                ...
                <?php $__currentLoopData = $korwils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($k->id); ?>" <?php echo e(request('korwil') == $k->id ? 'selected' : ''); ?>><?php echo e($k->name); ?></option>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <article class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            ...
            <div class="flex flex-wrap gap-2 text-xs mb-3">
                ...
                <span class="px-2 py-1 bg-green-50 text-green-700 rounded"><?php echo e($a->korwil->name); ?></span>
            </div>
        ...
        <tbody class="divide-y divide-gray-200">
            <?php $__empty_1 = true; $__currentLoopData = $anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 text-sm"><?php echo e($a->korwil->name); ?></td>
