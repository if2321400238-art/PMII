<?php $__env->startSection('title', 'Edit Profil Organisasi'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-6xl mx-auto">
        ...
        <form action="<?php echo e(route('admin.profil-organisasi.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   id="nama_organisasi"
                                   value="<?php echo e(old('nama_organisasi', $profil->nama_organisasi)); ?>"
                        ...
                        <div>
                            ...
                            <?php if($profil->logo_path): ?>
                                <div class="mb-3 inline-block">
                                    <img src="<?php echo e(asset('storage/' . $profil->logo_path)); ?>" alt="Logo" class="h-20 w-20 object-contain border-2 border-gray-200 rounded-lg p-2 bg-gray-50">
                                </div>
                            <?php endif; ?>
                            <input type="file"
                                   name="logo_path"
                    ...
                    <div class="p-6">
                        <div class="grid md:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if($profil->hero_image): ?>
                                    <img src="<?php echo e(asset('storage/' . $profil->hero_image)); ?>" alt="Hero 1" class="w-full h-32 object-cover rounded-lg border-2 border-gray-200">
                                <?php else: ?>
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if($profil->hero_image_2): ?>
                                    <img src="<?php echo e(asset('storage/' . $profil->hero_image_2)); ?>" alt="Hero 2" class="w-full h-32 object-cover rounded-lg border-2 border-gray-200">
                                <?php else: ?>
                                    <div class="w-full h-32 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
                                        <span class="text-gray-400 text-sm">Belum ada gambar</span>
                                    </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <?php if($profil->hero_image_3): ?>
                                    <img src="<?php echo e(asset('storage/' . $profil->hero_image_3)); ?>" alt="Hero 3" class="w-full h-32 object-cover rounded-lg border-2 border-gray-200">
                                <?php else: ?>
                                    <div class="w-full h-32 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
                                        <span class="text-gray-400 text-sm">Belum ada gambar</span>
                                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="sejarah" id="sejarah" rows="5"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
                                      placeholder="Tulis sejarah organisasi..."><?php echo e(old('sejarah', $profil->sejarah)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="visi" id="visi" rows="3"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
                                      placeholder="Tulis visi organisasi..."><?php echo e(old('visi', $profil->visi)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="misi" id="misi" rows="5"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
                                      placeholder="Tulis misi organisasi..."><?php echo e(old('misi', $profil->misi)); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="struktur_organisasi" id="struktur_organisasi" rows="4"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
                                      placeholder="Tulis struktur organisasi..."><?php echo e(old('struktur_organisasi', $profil->struktur_organisasi)); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/profil-organisasi/edit.blade.php ENDPATH**/ ?>