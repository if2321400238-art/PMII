    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="block md:hidden space-y-4">
            <?php $__empty_1 = true; $__currentLoopData = $galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                    <div class="flex justify-between items-start mb-2">
                        <div class="flex-1 min-w-0 pr-2">
                            <h3 class="font-semibold text-gray-900 text-base line-clamp-2"><?php echo e($gallery->title); ?></h3>
                            <p class="text-xs text-gray-500 mt-1 line-clamp-2"><?php echo e(Str::limit($gallery->description, 60)); ?></p>
                        </div>
                        <span class="flex-shrink-0 px-2.5 py-1 text-xs font-semibold rounded-full <?php echo e($gallery->type === 'photo' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'); ?>">
                    ...
                    <div class="flex flex-wrap gap-2 text-xs text-gray-600 mb-3">
                        <?php if($gallery->kegiatan): ?>
                            <span class="flex items-center">
                                ...
                                <?php echo e($gallery->kegiatan); ?>

                            </span>
                        <?php endif; ?>
                        <?php if($gallery->tahun): ?>
                            <span class="flex items-center">
                                <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <?php echo e($gallery->tahun); ?>
                    ...
                    <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-100">
                        ...
                        <form action="<?php echo e(route('admin.gallery.destroy', $gallery)); ?>" method="POST" onsubmit="return confirm('Hapus item ini?')" class="flex-1">
                            <?php echo csrf_field(); ?>
                ...
                <?php if(in_array($role, ['admin', 'pb']) && $gallery->approval_status === 'pending'): ?>
                    <div id="reject-form-gallery-<?php echo e($gallery->id); ?>" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
