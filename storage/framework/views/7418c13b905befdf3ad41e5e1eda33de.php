                    ...
                    <div data-hero-slider-card class="hero-mobile-contrast relative flex-1 min-h-0 hero-mobile-media rounded-3xl border border-white/20 overflow-hidden shadow-xl shadow-black/30 mt-4">
                            ...
                            <div class="hero-slider absolute inset-0">
                                <?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $heroImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="hero-slide absolute inset-0 transition-opacity duration-1000 <?php echo e($index === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'); ?>" data-index="<?php echo e($index); ?>">
                                        <img src="<?php echo e(route('img.optimized', ['path' => $heroImage, 'w' => 900])); ?>" alt="Hero PMII <?php echo e($index + 1); ?>" class="w-full h-full object-cover" loading="<?php echo e($index === 0 ? 'eager' : 'lazy'); ?>" fetchpriority="<?php echo e($index === 0 ? 'high' : 'low'); ?>" decoding="async" onerror="this.style.opacity='0'; this.parentElement.classList.add('bg-gradient-to-br','from-blue-800','to-blue-900');">
                        ...
                        <?php if(count($heroImages) > 1): ?>
                            <div class="absolute bottom-4 right-4 z-30 flex gap-2" role="tablist" aria-label="Slide hero">
                                <?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $heroImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <button
                                        class="hero-dot h-2.5 w-2.5 rounded-full <?php echo e($index === 0 ? 'bg-white' : 'bg-white/40'); ?> transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
                        ...
                        <div data-hero-slider-card class="premium-tilt relative rounded-2xl overflow-hidden border border-white/20 flex-1 min-h-0 shadow-xl shadow-black/30" data-premium-tilt>
                            <?php if(count($heroImages) > 0): ?>
                                <div class="hero-slider absolute inset-0">
                                    <?php $__currentLoopData = $heroImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $heroImage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="hero-slide absolute inset-0 transition-opacity duration-1000 <?php echo e($index === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'); ?>" data-index="<?php echo e($index); ?>">
                                            <img src="<?php echo e(route('img.optimized', ['path' => $heroImage, 'w' => 1280])); ?>" alt="Hero PMII <?php echo e($index + 1); ?>" class="w-full h-full object-cover" loading="<?php echo e($index === 0 ? 'eager' : 'lazy'); ?>" fetchpriority="<?php echo e($index === 0 ? 'high' : 'low'); ?>" decoding="async" onerror="this.style.opacity='0'; this.parentElement.classList.add('bg-gradient-to-br','from-blue-800','to-blue-900');">
