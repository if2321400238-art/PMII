    ...
    <div class="min-h-screen">
        ...
        <aside id="sidebar" class="fixed top-0 bottom-0 left-0 z-40 w-64 bg-gray-900 text-white overflow-y-auto" style="height: 100vh; min-height: 100%;">
            ...
            <nav class="p-3 space-y-1">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-green-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                ...
                <div class="dropdown-menu">
                    <button type="button" onclick="toggleDropdown('kontenMenu')" class="flex items-center justify-between w-full px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-gray-800 <?php echo e(request()->routeIs('admin.posts.*') || request()->routeIs('admin.gallery.*') || request()->routeIs('admin.download.*') ? 'bg-gray-800' : ''); ?>">
                ...
                <!-- SK Pengajuan -->
                <a href="<?php echo e(route('admin.sk-pengajuan.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm <?php echo e(request()->routeIs('admin.sk-pengajuan.*') ? 'bg-green-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                ...
                <?php if(in_array($role, ['admin', 'pb'])): ?>
                <!-- Kelola User -->
                <a href="<?php echo e(route('admin.user.index')); ?>" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm <?php echo e(request()->routeIs('admin.user.*') ? 'bg-green-600 text-white' : 'text-gray-300 hover:bg-gray-800'); ?>">
                ...
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="profileMenu" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 z-50">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded-t-lg">
                                Edit Profil
                            </a>
